    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <!-- Home Link -->
          <li class="nav-item">
            <a class="nav-link fs-6" href="home.php">
          ...
          <!-- Appointments Link -->
          <li class="nav-item">
            <a class="nav-link fs-6" href="index.php">
          ...
          <!-- Vehicles Link -->
          <li class="nav-item">
            <a class="nav-link fs-6" href="vehicle.php">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle fs-6" href="#" id="notifDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="fas fa-bell me-2"></i> Notifications <span class="badge bg-danger"><?= $notif_count ?></span>
            </a>
                ...
                <?php foreach ($notifications as $notification): ?>
                  <li>
                    <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#notifModal" data-id="<?= $notification['schedule_id'] ?>">
                      <i class="fas fa-calendar-check me-2"></i> New Appointment from <?= htmlspecialchars($notification['full_name']) ?>
                    </a>
                  </li>
                <?php endforeach; ?>
                <li><hr class="dropdown-divider"></li>
                <li><a class="dropdown-item" href="mark_all_read.php"><i class="fas fa-check me-2"></i> Mark all as read</a></li>
              <?php else: ?>
                <li><a class="dropdown-item" href="#"><i class="fas fa-exclamation-circle me-2"></i> No new notifications</a></li>
              <?php endif; ?>
            </ul>
          </li>
          ...
          <!-- Users Link -->
          <li class="nav-item">
            <a class="nav-link fs-6" href="users.php">
          ...
          <!-- OTP List Link -->
          <li class="nav-item">
            <a class="nav-link fs-6" href="otp.php">
              <i class="fas fa-key me-2"></i> OTP List
            </a>
          </li>
