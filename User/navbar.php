    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <!-- Vehicle Link -->
                <li class="nav-item">
                    <a class="nav-link" href="vehicle_main.php"><i class="fas fa-car me-2"></i>Vehicle</a>
                </li>

                <!-- Notifications Link -->
                <li class="nav-item">
                    <a class="nav-link" href="notifications.php"><i class="fas fa-bell me-2"></i>Notifications <span class="badge bg-danger"><?= $notif_count ?></span></a>
                </li>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
        <li><a class="dropdown-item" href="profile.php"><i class="fas fa-user me-2"></i><img src="<?php echo !empty($user['image']) ? htmlspecialchars($user['image']) : 'default.png'; ?>" alt="Profile Image"> Profile</a></li>
